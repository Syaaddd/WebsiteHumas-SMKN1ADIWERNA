...
$pdo    = getPDO();
$errors = [];
$data   = ['title' => '', 'content' => '', 'status' => 'draft', 'image' => ''];
...
if (isPost()) {
    ...
    if (empty($errors)) {
        ...
        $stmt->execute([$data['title'], $slug, $data['content'], $data['image'], $data['status']]);
...
<head>
    ...
    <title>Tambah Artikel — Admin Humas</title>
            ...
            <div class="space-y-4">
                ...
                <div class="bg-white rounded-xl shadow p-6">
                    ...
                    <input type="file" name="image" accept="image/jpeg,image/png,image/webp"
                        class="w-full text-sm text-gray-500 file:mr-3 file:py-1.5 file:px-3 file:rounded file:border-0 file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100">
